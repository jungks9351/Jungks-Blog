...
const PostSection = ({ posts }: { posts: Post[] }) => {
  return (
    <section className="py-10">
      <div className="space-y-2 lg:space-y-0 text-center px-2">
      ...
      <ul className="p-10 grid grid-cols-4 gap-x-4 md:grid-cols-8 lg:grid-cols-12 lg:gap-x-6 max-w-7xl gap-y-16 mx-auto">
        {posts.map((post, idx) => (
